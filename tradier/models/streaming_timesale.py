...
class StreamingTimesale(object):
    ...
    def bid(self, bid):
        ...
        if (self.local_vars_configuration.client_side_validation and
                bid is not None and not re.search(r'^[0-9]+$', bid)):  # noqa: E501
            raise ValueError(r"Invalid value for `bid`, must be a follow pattern or equal to `/^[0-9]+$/`")  # noqa: E501
    ...
    def ask(self, ask):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                ask is not None and not re.search(r'^[0-9]+$', ask)):  # noqa: E501
            raise ValueError(r"Invalid value for `ask`, must be a follow pattern or equal to `/^[0-9]+$/`")  # noqa: E501
    ...
    def last(self, last):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                last is not None and not re.search(r'^[0-9]+$', last)):  # noqa: E501
            raise ValueError(r"Invalid value for `last`, must be a follow pattern or equal to `/^[0-9]+$/`")  # noqa: E501
    ...
    def size(self, size):
        ...
        """
        if (self.local_vars_configuration.client_side_validation and
                size is not None and not re.search(r'^[0-9]+$', size)):  # noqa: E501
            raise ValueError(r"Invalid value for `size`, must be a follow pattern or equal to `/^[0-9]+$/`")  # noqa: E501
