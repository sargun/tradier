...
from tradier_asyncio.models.quotes import Quotes  # noqa: E501
...
class TestQuotes(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = tradier_asyncio.models.quotes.Quotes()  # noqa: E501
        if include_optional :
            return Quotes(
                quotes = tradier_asyncio.models.quotes_quotes.quotes_quotes(
                    quote = [
